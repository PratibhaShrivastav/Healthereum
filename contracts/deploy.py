...
def deploy_contract(contract_interface):
    ...
    print(contract)
    # tx_hash = contract.sendTransaction(transaction={'from': web3Instance.eth.accounts[0]})   # Get transaction hash from deployed contract
    ...
    tx_receipt = web3Instance.eth.waitForTransactionReceipt(tx_hash)
    return tx_receipt['contractAddress']
...
MedicalContract = contracts["contracts"]["PatientRecords.sol"]["PatientRecords"]    #Selecting relevant data from output of Compile function
